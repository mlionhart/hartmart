      ...
      <Container className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col gap-y-4">
          ...
          <p>
            ...
            accusantium enim deleniti facilis tempora fuga eius impedit
            accusamus vitae. Cumque, quo aliquid nihil, eaque nisi neque
            eligendi corporis.
          </p>
          <div className="flex items-center gap-x-4">
            <a href="https://www.youtube.com/c/MikeHartChannel" target="_blank">
        ...
        <div>
          ...
          <ul className="text-sm font-light mt-2 flex flex-col gap-y-2">
            <li className="flex flex-col">
              ...
              <span className="text-orange-600">January 31, 2024</span>
            </li>
            <li className="flex flex-col">
              <span className="text-slate hover:text-orange-600 cursor-pointer duration-200">
                Sports Brand New Advertising Campaign
              </span>
              <span className="text-orange-600">May 1, 2023</span>
            </li>
            <li className="flex flex-col">
              <span className="text-slate hover:text-orange-600 cursor-pointer duration-200">
                Snippets From The Tech Mobile Conference
              </span>
              <span className="text-orange-600">November 7, 2022</span>
            </li>
            <li className="flex flex-col">
              <span className="text-slate hover:text-orange-600 cursor-pointer duration-200">
